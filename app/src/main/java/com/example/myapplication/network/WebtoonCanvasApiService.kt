...
const val BASE_URL = "https://webtoon.p.rapidapi.com/canvas/"
const val XRapidAPIHostadress = "webtoon.p.rapidapi.com"
const val XRapidAPIkey = "83abec409emshdaef86121bb4e5ep125787jsnd79326c26832"
...
interface WebtoonCanvasApiService {
    ...
    // Les deux headers sont les clé d'accées à l'API et l'adresse de l'host
    ...
    suspend fun getSearch(
        @Query("query") searchquery: String, @Query("startIndex") debutpage: Int, @Query("pageSize") nbtitles: Int, @Query("language") lang: Langage
    ): RequestSearch
    ...
    suspend fun getTitlesList(
        ...
        @Query("sortOrder") sortOrder: String, @Query("startIndex") debutpage: Int, @Query("pageSize") nbtitles: Int, @Query("lang") lang: Langage
    ): RequestTitleList

    @Headers(XRapidAPIkey, XRapidAPIHostadress)
    @GET("titles/get-info")
    suspend fun getTitleInfo(
        @Query("titleNo") titleNo: String, @Query("lang") lang: Langage
    ): RequestTitleInfo
